...
[ -z $SUSFS_SETUP_SCRIPT ] && SUSFS_SETUP_SCRIPT="https://raw.githubusercontent.com/rifsxd/KernelSU-Next/next/kernel/setup.sh"
...
if [ "$SUSFS4KSU" = "true" ]; then
    curl -LSs $SUSFS_SETUP_SCRIPT | bash -s next-susfs
else
